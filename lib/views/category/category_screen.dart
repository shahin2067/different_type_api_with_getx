          ...
          SizedBox(
            ...
            child: Obx(()=>ListView.builder(
                ...
                itemBuilder: (context, index){
                  return InkWell(
                    onTap: (){
                      _controller.getCategoryViewData(category: _controller.categoryList[index]);
                      //Get.toNamed(HomeScreen.routeName, (route) => false);
                      Get.toNamed(CategoryViewScreen.routeName);
                    },
                    child: Card(
                      child: Container(
